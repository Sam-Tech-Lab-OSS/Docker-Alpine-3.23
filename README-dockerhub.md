...
Minimal, hardened, multi-architecture **Alpine 3.23** base image, built `FROM
...
<https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23>
...
Monthly rebuilds pick up the security updates Alpine publishes for 3.23. Published
...
```bash
docker pull samtechlab/alpine-3.23@sha256:<digest>
```
...
cosign verify \
  ...
  samtechlab/alpine-3.23@sha256:<digest>
```
...
Also published on GHCR as `ghcr.io/sam-tech-lab-oss/alpine-3.23`.
...
# Check who you are
docker run --rm samtechlab/alpine-3.23:latest id
```
...
```dockerfile
FROM samtechlab/alpine-3.23:latest
...
```bash
docker run --init samtechlab/alpine-3.23:latest your-command
```

```yaml
services:
  app:
    image: samtechlab/alpine-3.23:latest
    init: true
```
...
[s6-overlay variant](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-13-3.23-S6-Overlay)
of this same 3.23 base covers that case.
...
[SECURITY.md](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23/blob/main/SECURITY.md)
...
More entries in the
[full documentation](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23#troubleshooting).
...
Apache 2.0 — see
[LICENSE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23/blob/main/LICENSE) and
[NOTICE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23/blob/main/NOTICE).
Copyright (c) 2026 Sam Tech Lab.

---
---

# Alpine 3.23 — image de base

Image de base **Alpine 3.23** minimale, durcie et multi-architecture, construite
...
3.23. Les analyses de vulnérabilités publiées remontent aussi bien les vulnérabilités sans
...
Également publiée sur GHCR : `ghcr.io/sam-tech-lab-OSS/alpine-3.23`.
...
```bash
docker run --init samtechlab/alpine-3.23:latest votre-commande
```
...
[variante s6-overlay](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-13-3.23-S6-Overlay)
de la même base 3.23 couvre ce cas.
...
[documentation complète](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23#dépannage).
...
Apache 2.0 — voir
[LICENSE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23/blob/main/LICENSE) et
[NOTICE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23/blob/main/NOTICE).
Copyright (c) 2026 Sam Tech Lab.
